  ...
  },
  {
    ...
    config = function()
      ...
      lspconfig.clangd.setup({
        ...
        cmd = { "clangd", "--query-driver=C:/msys64/mingw64/bin/g*.exe", "--background-index", "--clang-tidy", "--compile-commands-dir=./build-debug", "--header-insertion=never", "--inlay-hints=true", "--completion-style=detailed" },
        filetypes = { "c", "cpp" },
